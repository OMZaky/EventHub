...
📊 View the full UML Class Diagram
...
Tip for developers: If you wish to customize the folder structure for your local environment, open .vscode/settings.json and update the related settings.
